...
print("mean, median and mode of weight is {}, {}, {} respectively".format(weight_mean, weight_median, weight_mode))
...
print("{}% of data for height lies within 1 stdev".format(len(height_list_of_data_within_1_stdev)*100.0/ len(height_list)))
print("{}% of data for height lies within 2 stdev".format(len(height_list_of_data_within_2_stdev)*100.0/ len(height_list)))
print("{}% of data for height lies within 3 stdev".format(len(height_list_of_data_within_3_stdev)*100.0/ len(height_list)))

print("{}% of data for weight lies within 1 stdev".format(len(weight_list_of_data_within_1_stdev)*100.0/ len(weight_list)))
print("{}% of data for weight lies within 2 stdev".format(len(weight_list_of_data_within_2_stdev)*100.0/ len(weight_list)))
print("{}% of data for weight lies within 3 stdev".format(len(weight_list_of_data_within_3_stdev)*100.0/ len(weight_list)))